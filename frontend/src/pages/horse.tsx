...
import backgroud from "../assets/bg5.jpg";
  ...
  return (
    <section className="w-full h-full absolute">
      <img
        ...
        alt="Horse"
      />
      <div className="w-full h-screen border backdrop-blur-none supports-[backdrop-filter]:bg-background/60 px-4 ">
        <div className="flex flex-row justify-between p-4">
          <h1 className="text-left text-2xl font-bold uppercase">Horse Management</h1>
        </div>
        ...
        <div className="h-56 grid grid-cols-3 gap-4 content-start px-4 mt-5">
          {horses.length > 0 &&
            horses.map((horse) => (
              <Card
                key={horse.ID}
